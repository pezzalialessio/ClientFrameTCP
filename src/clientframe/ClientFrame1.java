...
public class ClientFrame1 extends javax.swing.JFrame {
    ...
    public ClientFrame1() throws UnknownHostException, IOException {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try{            
                ...
                jTextArea1.append("Client: " +messageOut + "\n");
                pr.println(messageOut);
                pr.flush();
                messageIn = buf.readLine();
                jTextArea1.append("Server: " +messageIn + "\n");
                jTextField1.setText("");      
        }catch(IOException e){
            jTextArea1.append("Server disconnesso...\n");
        }
